module.exports = {
    ...
    token: "MTEzNzc2MTEwNzE1MTQ0MTk0MA.GmZEwI.rVfcvY_EPutbEKK7dogrTcHn_MOBmBF2ri-cBw", //Bot Tokeniniz => Bot Oluşturduktan Sonra Intentsleri Açmayı Unutma!
    guildID: "7971387682295644186", //Kullanıcağın Sunucunun ID'si
    voiceChannelID: "1050127637944750160", // Ses Kanal ID'si
    presence: "BUNY Özel Bot", //Botun Durumu
    footer: "FlyBUNY", //Embedların Footer Yazısı
    botOwners: ["937281246621491280"], //Bot Sahibinin ID'si
    prefix: "!", //Botun Prefix'i 
    manemoji: "♂️", //Erkek Emojisi
    womanemoji: "♀️", //Kadın Emojisi
    tagSymbol: "BUNY |", //Sunucunun Taglı İsim Sembolu => Eğer Tagınız Yoksa Boş Bırakın Veya "•" Kalsın
    normalSymbol: "BUNY |", //Normal Kayıt Olucak Kullanıcıların Başına Gelicek Sembol
